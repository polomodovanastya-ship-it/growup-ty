...
const stages = [
  ...
  },
  {
    ...
    text: "Пройден большой путь. Ты понимаешь, что получается, и начинаешь делать это по-своему. Задача — не подгонять себя под чужой шаблон, а собрать свой стиль и выйти в реальный опыт: отклик, стажировку, подработку, проект.",
    points: [
