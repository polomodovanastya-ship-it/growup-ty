...
const flow: FlowStep[] = [
  {
    ...
    detail:
      "Накрыло после ссоры, контрольной, расставания. Через несколько дней отпускает, спать и есть получается. Смотри, в какой сфере сложнее всего:",
    branches: [
      {
        icon: HeartHandshake,
  ...
  },
  {
    ...
    detail:
      "Почти каждый день нет сил, ничего не радует, тревога фоном, мысли крутятся по кругу, учёба и общение просели.",
    answer: "Психотерапевт — работа курсом по методике, а не разовый разговор",
    tone: "mid",
  },
  {
    icon: AlertTriangle,
    condition: "Тело и психика уже не справляются",
    detail:
      "Не спишь неделями, резкие перепады состояния, паника, мысли навредить себе, привычная жизнь остановилась.",
    answer: "Психиатр — сначала врач. Это не «учёт» и не «клеймо», а помощь",
    tone: "alert",
  },
];
