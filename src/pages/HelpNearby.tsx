        ...
        <ScrollReveal>
          <div className="h-full rounded-3xl border bg-card p-6 flex flex-col">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto pt-2.5 inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-5 py-2.5 text-sm font-medium hover:opacity-90 transition-opacity"
            >
